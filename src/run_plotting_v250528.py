...
def main():
    ...
    data_dir = f'{verification_out_dir}/SCORE/{region_name}/{var}/'
    ...
    for yyyymm in yyyymm_list:
        plot_rpss_map(var, yyyymm, region_name, data_dir, fig_dir)
        plot_roc_by_lead_per_init(var, yyyymm, region_name, data_dir, fig_dir)
