...
yyyymm_list = generate_yyyymm_list(year_start, year_end) # 예측자료 년월 리스트
...
def run_tercile_categorize_obs():
...
def run_tercile_categorize_fcst():
    logger.info("[INFO] Step 4: Categorize forecast deterministic tercile & Probabilistic prediction...")
    # 예측 삼분위 분류
...
def main():
    ...
    if model_option == 'y':
        ...
        run_tercile_categorize_obs()  # Updated function call
        run_tercile_categorize_fcst()  # Added function call for forecast categorization
